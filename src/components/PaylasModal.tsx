        ...
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-black/70 backdrop-blur-sm p-0 sm:p-4"
          ...
          >
            ...
            <div className="mb-6 p-4 bg-slate-800/50 border border-slate-700 rounded-2xl text-center">
              <p className="text-slate-400 text-sm mb-1">Klinik Onaylı Gençlik Skoru</p>
              <p className="text-5xl font-black text-emerald-400 mb-1">{score}</p>
              <p className="text-slate-500 text-sm">{firstName}{clinicName ? ` · ${clinicName}` : ''}</p>
            </div>
            ...
            <div className="grid grid-cols-5 gap-2 mb-3">
              ...
              <button onClick={handleInstagram} disabled={downloading}
                ...
                <span className="text-sm text-slate-300">{downloading ? '...' : 'Instagram'}</span>
              </button>
            ...
            {instagramHint && (
              <div className="mb-3 p-3 rounded-xl bg-gradient-to-r from-[#833AB4]/15 via-[#FD1D1D]/15 to-[#FCB045]/15 border border-[#FD1D1D]/30">
                <p className="text-sm text-slate-200 font-medium mb-1">✓ Görsel indirildi</p>
            ...
            <button onClick={handleCopy}
              ...
              <span className="flex-1 text-sm text-left font-mono truncate text-slate-400">
                {shareUrl}
              </span>
              <span className={`text-sm font-bold ${copied ? 'text-emerald-400' : 'text-violet-400'}`}>
