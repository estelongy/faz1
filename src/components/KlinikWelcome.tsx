      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="relative p-6 rounded-2xl bg-slate-800/60 border border-slate-700 hover:border-violet-500/40 transition-colors">
          ...
          <button onClick={handleCopy}
            ...
            <span className="truncate font-mono text-sm">{shareUrl.replace('https://', '')}</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <Link href="/klinik/panel/kredi"
          ...
          <div className="min-w-0">
            ...
            <div className="text-slate-500 text-sm truncate">Paket satın al, işlem geçmişi</div>
          </div>
        ...
        <Link href="/hakkinda/sss"
          ...
          <div className="min-w-0">
            ...
            <div className="text-slate-500 text-sm truncate">SSS & klinik rehberi</div>
          </div>
          <svg className="w-4 h-4 text-slate-500 group-hover:text-white ml-auto shrink-0 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
        ...
        <Link href="/hakkinda/iletisim"
          ...
          <div className="min-w-0">
            ...
            <div className="text-slate-500 text-sm truncate">klinik@estelongy.com</div>
          </div>
          <svg className="w-4 h-4 text-slate-500 group-hover:text-white ml-auto shrink-0 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
