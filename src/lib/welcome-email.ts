...
const ROLE_META: Record<WelcomeRole, { subject: string; heading: string; body: string; ctaLabel: string; ctaPath: string }> = {
  ...
  clinic: {
    subject: 'Estelongy Klinik Başvurunuz Alındı',
    heading: 'Başvurunuz inceleniyor',
    body: 'Klinik başvurunuz Estelongy ekibi tarafından incelenmek üzere kuyruğa alındı. Onaylandığında klinik panelinize erişebileceksiniz. Süreç en geç 48 saat içinde tamamlanır.',
    ctaLabel: 'Klinik Panelim',
    ctaPath: '/klinik/panel',
  },
  vendor: {
    subject: 'Estelongy Satıcı Başvurunuz Alındı',
    heading: 'Başvurunuz inceleniyor',
    body: 'Satıcı başvurunuz Estelongy ekibi tarafından incelenmek üzere kuyruğa alındı. Onaylandığında ürünlerinizi yükleyebileceksiniz. Süreç en geç 48 saat içinde tamamlanır.',
    ctaLabel: 'Satıcı Panelim',
