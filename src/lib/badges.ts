...
export const BADGE_META: Record<BadgeKey, { emoji: string; label: string; desc: string; color: string }> = {
  ilk_analiz:    { emoji: '🔬', label: 'İlk Analiz',      desc: 'İlk Gençlik Skoru analizini yaptın',       color: 'from-violet-500/20 to-purple-500/20 border-violet-500/30' },
  ...
  klinik_onayli: { emoji: '✦',  label: 'Klinik Onaylı',   desc: 'Klinik onaylı Gençlik Skorun var',         color: 'from-[#00d4ff]/20 to-blue-500/20 border-[#00d4ff]/30' },
  premium_skor:  { emoji: '🌟', label: 'Harika',           desc: 'Gençlik Skorun 90 veya üzerinde!',         color: 'from-amber-500/20 to-yellow-500/20 border-amber-500/30' },
  genc_skor:     { emoji: '💚', label: 'İyi Seviye',       desc: 'Gençlik Skorun 80 veya üzerinde!',         color: 'from-green-500/20 to-emerald-500/20 border-green-500/30' },
