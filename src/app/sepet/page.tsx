                ...
                return (
                  <div key={vendorId} className="bg-slate-800/50 border border-slate-700 rounded-2xl overflow-hidden">
                    <div className="px-5 py-3 border-b border-slate-700 flex items-center justify-between">
                      ...
                      <span className="text-slate-500 text-sm">₺{vendorTotal.toLocaleString('tr-TR')}</span>
                    </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-slate-800/50 border border-slate-700 rounded-2xl p-6">
                ...
                <div className="space-y-3 text-sm mb-6">
                  ...
                  <div className="flex justify-between text-slate-400">
                    <span>Kargo</span>
                    <span className="text-slate-500 text-sm">Ödeme adımında</span>
                  </div>
                ...
                <div className="mt-4 flex items-start gap-2 text-slate-500 text-sm leading-relaxed">
