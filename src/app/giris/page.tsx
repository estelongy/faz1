...
function GirisInner() {
  ...
  async function handleGoogleLogin() {
    ...
    const redirectTo = `${location.origin}/auth/callback?next=${encodeURIComponent(nextParam)}`
            ...
            <>
              ...
              <div className="mt-4">
                <div className="relative my-4">
                  ...
                  <div className="relative flex justify-center"><span className="bg-slate-800/50 px-3 text-xs text-slate-500">veya</span></div>
                </div>
                <button
                  type="button"
                  onClick={handleGoogleLogin}
                  disabled={googleLoading}
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white hover:bg-gray-50 disabled:opacity-60 rounded-xl text-gray-800 text-sm font-medium transition-all shadow-sm">
              ...
              <div className="mt-3 pt-4 border-t border-slate-700">
