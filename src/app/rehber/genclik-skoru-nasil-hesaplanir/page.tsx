        ...
        <article className="max-w-3xl mx-auto px-4 py-12">
          ...
          <div className="mt-6 p-8 rounded-2xl bg-gradient-to-br from-amber-600/20 to-orange-600/10 border border-amber-500/30 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/klinikler/randevu" className="px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl border border-slate-600 transition-colors">
                Klinik Onayına Ulaş
              </Link>
            </div>
          </div>
