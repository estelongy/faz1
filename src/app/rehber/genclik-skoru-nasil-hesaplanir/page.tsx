      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800">
        <header className="bg-slate-900/80 backdrop-blur-md border-b border-white/5 sticky top-0 z-40">
          <div className="max-w-3xl mx-auto px-4 h-16 flex items-center gap-3 text-sm">
            ...
            <Link href="/rehber" className="text-slate-500 hover:text-white transition-colors">Estelongy Rehberi</Link>
            <span className="text-slate-700">›</span>
          ...
          <div className="mt-12 pt-8 border-t border-slate-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                <Link key={l.href} href={l.href} className="flex items-center gap-2 p-3 rounded-xl bg-slate-800/50 border border-slate-700 hover:border-slate-500 text-slate-300 hover:text-white text-base transition-all font-semibold">
                  <span>{l.icon}</span>
