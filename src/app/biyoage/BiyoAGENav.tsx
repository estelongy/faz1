    ...
    <header className="sticky top-0 z-50 bg-[#1B1330] border-b border-[#3D2C66]/60 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <nav className="flex items-center gap-1 sm:gap-2 order-1">
          <Link
            href="/rehber"
            className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-base font-medium text-violet-100 hover:bg-white/10 transition-colors"
          >
            <ShieldCheck size={13} />
            Rehber
          </Link>
        ...
        <Link
          ...
          className="order-3 group inline-flex items-center gap-2 px-4 sm:px-5 h-10 rounded-full bg-[#9F8CE0] hover:bg-[#8B76D4] text-[#1B1330] font-bold text-base tracking-tight transition-colors shadow-lg shadow-[#9F8CE0]/30"
        >
